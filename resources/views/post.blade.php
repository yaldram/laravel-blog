					...
					<div class="main-post">
						...
						<div class="blog-post-inner">
							...
							<div class="post-info">
								...
								<div class="left-area">
									<a class="avatar" href="{{ route('author.profile', $post->user->username) }}"><img src="{{ asset('storage/profile/'.$post->user->image) }}"></a>
								</div>
						...
						<div class="single-post post-style-1">
							...
							<div class="blog-info">
								...
								<ul class="post-footer">
                                    ...
                                    @else
                                     <a class="{{ !Auth::user()->favorite_posts->where('pivot.post_id', $randompost->id)->count() == 0 ? 'favorite_posts' : '' }}" 
                                     href="javascript:void(0);" 
					...
					<div class="commnets-area ">
						...
						<div class="comment">
							...
							<div class="post-info">
								...
								<div class="left-area">
									<a class="avatar" href="#"><img src="{{ asset('/storage/profile/'.$comment->user->image) }}"></a>
								</div>
